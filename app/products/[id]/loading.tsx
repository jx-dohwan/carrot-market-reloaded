...
export default function Loading() {
    return (
        <div className="animate-;ulse p-5 flex flex-col gap-5">
            <div className="aspect-square border-neutral-700 text-neutral-700 border-4 vorder-dashed rounded-md flex justify-center items-center">
